...
kittens.addToTail('https://res.cloudinary.com/app-academy4/image/upload/v1642607318/kittens/kitten1_gbur2r.jpg');
kittens.addToTail('https://res.cloudinary.com/app-academy4/image/upload/v1642607405/kittens/kitten2_mjar88.png');
kittens.addToTail('https://res.cloudinary.com/app-academy4/image/upload/v1642607472/kittens/kitten3_rc4kut.jpg');
kittens.addToTail('https://res.cloudinary.com/app-academy4/image/upload/v1642608508/kittens/kitten4_invlwr.jpg');
kittens.addToTail('https://res.cloudinary.com/app-academy4/image/upload/v1642609136/kittens/kitten5_kq7adi.jpg');
kittens.addToTail('https://res.cloudinary.com/app-academy4/image/upload/v1642609731/kittens/kitten6_ixmk2b.jpg');
kittens.addToTail('https://res.cloudinary.com/app-academy4/image/upload/v1642610764/kittens/kitten7_zekvxp.jpg');
kittens.addToTail('https://res.cloudinary.com/app-academy4/image/upload/v1642614229/kittens/kitten8_xrzadr.jpg');
kittens.addToTail('https://res.cloudinary.com/app-academy4/image/upload/v1642614772/kittens/kitten9_dkfykp.jpg');
// kittens.addToTail();

//  Potentially scary code we haven't learned about yet below...
const nullImage = 'https://res.cloudinary.com/app-academy4/image/upload/v1629224425/puppies/null_ghib1q.png'
...
window.addEventListener("DOMContentLoaded", () => {
    ...
    deleteFromHead.addEventListener('click', (event) => {
        ...
        if (mainImageLoc.src === head.value) needToUpdateMain = true;
        if (prevImageLoc.src === head.value) needToUpdatePrev = true;

        kittens.removeFromHead();
        
        let mainImage = kittens.peekAtHead();

        if (needToUpdateMain || needToUpdatePrev) {
            update(mainImage, mainImage.next, mainImage.prev)
        }
    ...
    deleteFromTail.addEventListener('click', (event) => {
        ...
        if (mainImage.value === tailImage.value) needToUpdateMain = true;
        if (mainImage.next?.value === tailImage.value) needToUpdateNext = true;

        kittens.removeFromTail();

        if (needToUpdateMain) {
            update(prevImage, prevImage.next, prevImage.prev)
        }
